...
public class SecurityConfig {
	...
	.requestMatchers("/showCreate","/saveFormation").hasAnyAuthority("ADMIN","AGENT")
	.requestMatchers("/modifierFormation","/supprimerFormation").hasAnyAuthority("ADMIN")
	.requestMatchers("/listeFormations").hasAnyAuthority("ADMIN","AGENT","USER")
	 ...
	 * UserDetails userNadhem = User .withUsername("fatma")
